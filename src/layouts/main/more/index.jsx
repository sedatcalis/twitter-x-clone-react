...
export default function More() {
  return (
    <Popover className="relavite">
      ...
      <Popover.Panel className="w-[318px] absolute bottom-[125px]  bg-black shadow-box rounded-xl overflow-hidden">
        ...
        <Disclosure>
          ...
          <Disclosure.Panel className="text-gray-500">
            <Link
              to={"/"}
              className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium hover:bg-[#eff3f41a] text-white transition-colors"
            >
              <svg viewBox="0 0 24 24 " width={18.75} height={18.75}>
                <path
                  fill="currentColor"
